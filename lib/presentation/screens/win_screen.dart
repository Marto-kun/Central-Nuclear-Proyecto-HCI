...
import 'package:project_nuclear/presentation/providers/coolant_temperature_provider.dart';
import 'package:project_nuclear/presentation/providers/count_seconds_provider.dart';
import 'package:project_nuclear/presentation/providers/emergency_button_provider.dart';
...
import 'package:project_nuclear/presentation/widgets/widgets.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.check_circle, color: Colors.green, size: size.width * 0.12),
            ...
            Text(
              'Completaste la secuencia de parada a tiempo.',
